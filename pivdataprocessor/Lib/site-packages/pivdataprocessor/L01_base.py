...
class PIVDataProcessorBase:
    ...
    @classmethod
    def __from_csv_to_bin(cls, skip_rows:int = 5) -> None:
        '''
    ...
    # region 
    @classmethod
    def preprocess_data(cls, casename:str, if_bin_exist = False, skip_rows:int = 5) -> None:
        cls.load_case(casename=casename, ifinit=True)
        if if_bin_exist == False:
            cls.__check_path()
            cls.__from_csv_to_bin(skip_rows=skip_rows)
        ...
        path = cls.get_paths()['RawData'] + '/bin'
