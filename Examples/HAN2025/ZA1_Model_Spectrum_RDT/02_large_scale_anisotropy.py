...
from G01_large_scale_anisotropy import LargeScaleAnisotropy as LSA
from L02_RDT_integral import RDT_integral_calculator as RIC
...
ax.plot(lsa.c, lsa.uu_vv, label=r'Numerical solution ($Re_{\lambda}$=50)')
