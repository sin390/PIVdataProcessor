...
xlables = [r'$x$ (mm)']
ylables = [r'$y$ (mm)']
axtitles = ['Origin', 'Mode 1', 'Mode 2', 'Mode 3', 'Mode 4', 'Mode 5']
...
for case_id in range(fig_number):
    ...
    quiv = ax.quiver(X[::step, ::step], Y[::step, ::step],
                        ...
                        magnitude[::step, ::step],
                        cmap='viridis', clim=(global_min, global_max), scale=scale_factor, width = width)
