...
class POD(pTS):
    def __init__(self, casename):
        ...
        self.range = self.CaseInfo.Uniform_Range
        self.Nx = self.CaseInfo.Uniform_Range[0][1]-self.CaseInfo.Uniform_Range[0][0]
        self.Ny = self.CaseInfo.Uniform_Range[1][1]-self.CaseInfo.Uniform_Range[1][0]
