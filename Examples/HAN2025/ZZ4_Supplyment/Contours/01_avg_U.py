...
cases = ['Case01XZ_Y0_Ethanol', 'Case01XY_Z12_Ethanol']
...
cases_title = ['Case01XZ_Y0_Ethanol', 'Case01XY_Z12_Ethanol']
d_array_nozzle = 12  # mm
Uin = 404     # m/s
xlables = [r'$x/d_{a}$',r'$x/d_{a}$']
ylables = [r'$z/d_{a}$',r'$y/d_{a}$']
xlims = [(-4,4)]
xtricks = [-4,-2,0,2,4]
ylims = [(-2.3,2.3)]
ytricks = [-2,0,2]
