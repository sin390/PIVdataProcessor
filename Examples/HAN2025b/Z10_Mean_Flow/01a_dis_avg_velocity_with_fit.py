...
for case_id, case in enumerate(cases):
    ...
    y1 = fs.fit_avg_U[0][left:right,i_y[0]]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
    ...
    y1 = fs.fit_avg_U[0][left:right,i_y[1]]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
...
for case_id, case in enumerate(cases):
    ...
    y1 = fs.fit_avg_U[0][i_x[0],bottom:up]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
    ...
    y1 = fs.fit_avg_U[0][i_x[1],bottom:up]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
...
for case_id, case in enumerate(cases):
    ...
    y1 = fs.fit_avg_U[1][left:right,i_y[0]]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
    ...
    y1 = fs.fit_avg_U[1][left:right,i_y[1]]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
...
for case_id, case in enumerate(cases):
    ...
    y1 = fs.fit_avg_U[1][i_x[0],bottom:up]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
    ...
    y1 = fs.fit_avg_U[1][i_x[1],bottom:up]
    fig.plot(fig_id,x,y1, linestyle = ':', color=colors[case_id])
