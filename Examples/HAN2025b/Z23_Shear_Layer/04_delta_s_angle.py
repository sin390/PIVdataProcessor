...
fig.set_label(0,ylabel=r'$(\delta_s|_\theta)/L_f$')
fig.set_label(2,ylabel=r'$(\delta_s|_\theta)/L_f$')
fig.set_axis(0,xlim=(0,180),ylim=(0,1),xticks=[0,45,90,135,180])
fig.set_axis(1,xlim=(0,180),ylim=(0,1),xticks=[0,45,90,135,180])
fig.set_axis(2,xlim=(0,180),ylim=(0,1),xticks=[0,45,90,135,180])
fig.set_axis(3,xlim=(0,180),ylim=(0,1),xticks=[0,45,90,135,180])
for fig_id in range(4):
    fig.set_panel_label(fig_id)
fig.set_margins(right=0.8)
fig.legend(bbox_to_anchor=(0.7,0.5))
fig.save(getplotpath()+"/delta_s_angle.png")
