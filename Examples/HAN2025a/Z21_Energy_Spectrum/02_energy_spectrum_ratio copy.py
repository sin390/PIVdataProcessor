...
for case_id, case in enumerate(cases):
    ...
    E11k1 = es.spec_xdir[0]
    f1 = interp1d(np.log(k1), np.log(E11k1), kind=inter_kind, fill_value="extrapolate")

    k2 = es.wavenumber_ydir
    E11k2 = es.spec_ydir[0]
    f2 = interp1d(np.log(k2), np.log(E11k2), kind=inter_kind, fill_value="extrapolate")
