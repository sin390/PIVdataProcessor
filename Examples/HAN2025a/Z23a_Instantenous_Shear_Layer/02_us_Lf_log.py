...
for case_id, case in enumerate(A01.cases):
    ...
    fig.plot(fig_id,x,y,label=A01.case_labels[case_id], color=colors[case_id], marker='^',markersize = 5,ifmarker=True,xlog=True,ylog=True)
    _,_,y_fit = power_law_fit(x,y)
    fig.plot(fig_id,x,y_fit,label=A01.case_labels[case_id], color=colors[case_id], marker='+',markersize = 5,ifmarker=True,xlog=True,ylog=True)
...
fig.set_axis(0,xlim=(100,1300),ylim=(5,1e2))
fig.set_axis(1,xlim=(100,1300),ylim=(1e3,1e5))
fig.set_axis(2,xlim=(100,1300),ylim=(1e6,1e9))
