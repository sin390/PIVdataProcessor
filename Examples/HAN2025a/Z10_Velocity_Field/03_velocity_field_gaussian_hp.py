...
figformat = ".png"
fig_path = getplotpath()
result_fig = f"{fig_path}/instantaneous_velocity_gaussian_hp"
...
fig_id = 0
filter_id = 1
vfh = VFH(case, 'gaussian_hp', gaussian_id[filter_id-1])
vfh.load_X()
